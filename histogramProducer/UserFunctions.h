...
float sampleCrossSection(const string& inputFileName) {
  ...
  map<string,float> xs = {
    ...
    {"WGToLNuG-amcatnloFXFX", 512.1},
    {"WGToLNuG-madgraphMLM", 505.271},
    {"WGToLNuG-madgraphMLM_PtG-0to130", 505.271},
    {"WGToLNuG_PtG-500", 0.0117887},
    //{"WGJets_MonoPhoton_PtG-130", 0.834} // source: jlange
    {"WGJets_MonoPhoton_PtG-130", 0.87971},
    ...
    {"ZNuNuGJets_MonoPhoton_PtG-40to130", 3.87671},
    {"ZNuNuGJets_MonoPhoton_PtG-130", 0.2546},
    {"ZGTo2LG", 117.864},
    {"ZGTo2LGmod", 117.864},
