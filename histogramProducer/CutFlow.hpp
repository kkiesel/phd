  ...
  public:
    ...
    bool check( const tree::Photon& photon ){
      ...
      if( pass_EB ) {
        ...
        pass_nIso = photon.isoNeutralHadronsEA < cut_nIso1_eb + exp( cut_nIso2_eb * pt+ cut_nIso3_eb );
        ...
        pass_nIso = photon.isoNeutralHadronsEA < cut_nIso1_ee + exp( cut_nIso2_ee * pt+ cut_nIso3_ee );
